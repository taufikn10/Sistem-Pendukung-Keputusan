...
//QUERY :
$data_user = lihat("SELECT * FROM tb_users WHERE level = 'Developer' LIMIT $awalData, $jumlahDataPerHalaman");
?>
    ...
    <div class="main">
      ...
      <main class="content">
        <div class="container-fluid p-0">
          ...
          <h1 class="h3 mb-3">Data Developer</h1>

          <button type="button" class="btn btn-primary mb-4" data-toggle="modal" data-target="#tambah">Tambah Developer</button>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <div class="modal-body py-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="kode" class="form-control" id="kode" required value="A">
                    </div>
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="range">Nama Lengkap</label>
                      <input type="text" name="range" class="form-control" id="range" required>
                    </div>
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="range">Email</label>
                      <input type="text" name="range" class="form-control" id="range" required>
                    </div>
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="jenis">Alamat</label>
                      <input type="text" name="jenis" class="form-control" id="jenis" required>
                    </div>
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="bobot">Level</label>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title text-center">Kumpulan Data Developer</h3>
                  <hr>
                </div>
