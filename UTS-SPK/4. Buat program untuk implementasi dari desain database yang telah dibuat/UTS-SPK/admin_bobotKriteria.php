...
$jumlahData = count(lihat("SELECT * FROM tb_rentang"));
$jumlahHalaman =  ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;

//QUERY :
$data_nilai = lihat("SELECT * FROM tb_rentang LIMIT $awalData, $jumlahDataPerHalaman");
?>
    ...
    <div class="main">
      ...
      <main class="content">
        <div class="container-fluid p-0">
          ...
          <h1 class="h3 mb-3">Bobot Nilai Kriteria</h1>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <div class="modal-body py-3">
                    <div class="form-group">
                      <label style="color: black;" for="control-label" for="judul">Sub Kriteria</label>
                      <select name="subJudul" class="form-control" required>
                    ...
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="subKriteria">Sub Kriteria</label>
                      <input type="text" name="subKriteria" class="form-control" id="subKriteria" required>
                    </div>
                    <div class="form-group mt-2">
                      <label style="color: black;" for="control-label" for="nilai">Bobot(W)</label>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">C1 : Learnability</h3>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">C2 : Eficiency</h3>
                </div>
                <div class="table-responsive">
                  <table class="table mb-0 table table-bordered border-primary">
                    <thead class="">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">C3 : Memorability</h3>
                </div>
                <div class="table-responsive">
                  <table class="table mb-0 table table-bordered border-primary">
                    <thead class="">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">C4 : Error</h3>
                </div>
                <div class="table-responsive">
                  <table class="table mb-0 table table-bordered border-primary">
                    <thead class="">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">C4 : Satisfaction</h3>
                </div>
                <div class="table-responsive">
                  <table class="table mb-0 table table-bordered border-primary">
                    <thead class="">
